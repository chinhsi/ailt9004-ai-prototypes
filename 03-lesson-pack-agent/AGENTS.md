...
- Write exactly these five files, with these names: `00-teacher-notes.md`, `01-vocabulary.md`, `02-comprehension.md`, `03-cloze.md`, `04-quiz.html`. If you cannot finish one of them, say which one and why, rather than leaving the pack silently incomplete.
...
- Never process identifiable pupil work here. If the text looks like a pupil's writing, stop and say so: names, school, class number and personal details must be removed first, and the school's policy checked.
