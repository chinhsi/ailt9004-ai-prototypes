...
| 6 | [**认字乐园 Hanzi Game**](06-hanzi-game/) | Phone-first Chinese character game: five game types, Leitner spaced repetition, parent page — built by a coding agent from a one-page teacher brief | Vite + TypeScript + tests (source private; brief, build story and live game here) | ✅ [play](https://chinhsi.github.io/hanzi-game-pages/) |
