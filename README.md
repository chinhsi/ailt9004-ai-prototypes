...
| 3 | [**Lesson Pack Agent**](03-lesson-pack-agent/) | One command turns any text into vocabulary, questions, cloze, a quiz and teacher notes | OpenCode CLI + two plain-text rule files (no code at all) | ✅ [download the folder](https://github.com/chinhsi/ailt9004-ai-prototypes/raw/main/03-lesson-pack-agent/lesson-pack-agent.zip) · [set it up](03-lesson-pack-agent/RUN-IT-YOURSELF.md) |
