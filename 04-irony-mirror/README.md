...
6. Scroll to the poster at the bottom. Its four stanzas are four moves students can copy: a mock dictionary definition, a balanced couplet built on one pair of opposites, three parallel clauses with a turn, and an ironic compliment. English output gets the equivalent aphorism-stack form.
...
- **Pictures off**: set *Image provider* to *No pictures* and use the poster only — that is the 2025 experience, and a good "before/after" for students.
- **Settings → Card colour**: five palettes (lemon yellow on black by default, plus orange, deep blue, sage, paper). The poster downloads at 1440×2160, the right shape for Threads and Instagram.
